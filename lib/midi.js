...
/*
  ...
  // nrpn params
  this.nrpn_msb = arguments[2];
  this.nrpn_lsb = arguments[3];

  // prog change params
  this.prog_msb = arguments[2];
  this.prog_lsb = arguments[3];
  this.prog_num = arguments[4];
  */
}
  ...
  switch (this.type) {
    ...
    case "cc":
      ...
      case "nrpn":
        ...
        break;
      case "prog":
        var val = this.prog_num;
        if(arguments[0]) val = val = arguments[0];
